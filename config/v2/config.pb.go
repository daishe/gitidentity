...
const file_config_v2_config_proto_rawDesc = "" +
	"\n" +
	"\x16config/v2/config.proto\x12\x15gitidentity.config.v2\")\n" +
	...
	"\rConditionMode\x12\f\n" +
	"\bCONTAINS\x10\x00\x12\n" +
	"\n" +
	"\x06PREFIX\x10\x01\x12\n" +
	"\n" +
	"\x06SUFFIX\x10\x02\x12\b\n" +
	"\x04FULL\x10\x03\x12\x11\n" +
	"\rSHELL_PATTERN\x10\x04\x12\n" +
	"\n" +
	"\x06REGEXP\x10\x05B\xd0\x01\n" +
	"\x19com.gitidentity.config.v2B\vConfigProtoP\x01Z0github.com/daishe/gitidentity/config/v2;configv2\xa2\x02\x03GCX\xaa\x02\x15Gitidentity.Config.V2\xca\x02\x15Gitidentity\\Config\\V2\xe2\x02!Gitidentity\\Config\\V2\\GPBMetadata\xea\x02\x17Gitidentity::Config::V2b\x06proto3"

var (
	file_config_v2_config_proto_rawDescOnce sync.Once
	file_config_v2_config_proto_rawDescData []byte
)

func file_config_v2_config_proto_rawDescGZIP() []byte {
	file_config_v2_config_proto_rawDescOnce.Do(func() {
		file_config_v2_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_v2_config_proto_rawDesc), len(file_config_v2_config_proto_rawDesc)))
	})
...
var file_config_v2_config_proto_goTypes = []any{
...
func file_config_v2_config_proto_init() {
	...
	file_config_v2_config_proto_msgTypes[4].OneofWrappers = []any{
		(*Match_Env)(nil),
		(*Match_Remote)(nil),
		(*Match_Command)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v2_config_proto_rawDesc), len(file_config_v2_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
